  ...
  return (
    <div className={`productInfo flex flex-col pb-[150px] ${nightMood&&'text-zn-white'}`}> 
       ...
       <div className='flex-1'>
        ...
        <div className="product-details sm:ml-[95px] ml-8 mt-10 max-sm:mt-8 max-sm:pr-2 text-pretty 2xl:max-w-[950px] xl:max-w-[850px]  md:max-w-[700px] sm:max-w-[500px] max-w-[400px]">
