...
const ProductImg = ({img,shade,type}) => {
  ...
  return (
    <>  
      <div className='productImg 2xl:w-[330px] 2xl:h-[290px] xl:h-[264px] xl:w-[272px] lg:w-[200px] lg:h-[192px] max-lg:h-[210px] max-lg:w-[220px] max-md:h-[240px] max-md:w-[258px] max-sm:h-[280px] max-sm:w-[290px] snap-start snap-always relative'
